...
For the application in automobile interiors, this paper studies the nesting optimization problem in leather manufacturing. (<mark>这个即便在CNS里面，也会有这么写的。模仿CNS文章 (外教总说CNS文章写的烂)，也有了每个section以目的句开头的习惯，还是多看看老外写的，找找规律，能不能矫正过来</mark>)
