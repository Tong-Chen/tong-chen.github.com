...
* 安装redis
  ...
  3. The TCP backlog setting of 511 cannot be enforced: `echo 511 > /proc/sys/net/core/somaxconn` [REF](https://github.com/docker-library/redis/issues/35#issuecomment-160620511)
