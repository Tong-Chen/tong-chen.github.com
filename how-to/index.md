...
2. Clone a constructed jekyll repository.
  ...
  * Windows: Fork the repository [jekyll-bootstrap](https://github.com/plusjade/jekyll-bootstrap/fork) at <www.github.com> and clone it to local computer and put it into your local github repository. 
